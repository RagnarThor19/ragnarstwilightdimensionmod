...
import net.ragnar.ragnarstwilightdimension.client.render.DeepSteveRenderer;
...
public class RagnarsTwilightDimensionClient implements ClientModInitializer {
    ...
    public void onInitializeClient() {
        ...
        EntityRendererRegistry.register(ModEntities.DEEP_STEVE, DeepSteveRenderer::new);
